...
if (!file_exists('commonCore.php')) 
  die ('<body>ERROR!!! HRC2Index2-19, Cannot process the HRCloud2 Common Core file (commonCore.php)!'.PHP_EOL.'</body></html>'); 
...
<div id="HRAIDiv" style="float: center; ">
  ...
  <form action="index2.php"><button id="button" name="button5" class="button" style="float:left;" href="#" onclick="toggle_visibility('loadingCommandDiv');">&#x21BA;</button></form>
  </div>
...
<div id="cloudContentsDiv" align='center'>
  <iframe src="cloudCore.php" id="cloudContents" name="cloudContents" width="815px" style="min-height:450px; max-height:950px; padding-top:-4px; padding-left:-4px; border:inset;" onload="document.getElementById('loading').style.display='none';"></iframe>
</div>
</div>
<?php 
if ($ShowHRAI == '1') {
