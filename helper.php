...
<hr />
<div align="center">
<form action"https://github.com/zelon88/HRCloud2/wiki/FAQ" method"post">
<p><input type="submit" id="faqbutton" name="submitsmall" value="Official Wiki"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="About HRCloud2"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="Latest Commits"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="Dependency Info"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="Technical Breakdown"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="FAQ"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="Report A Bug"></input></p>
<p><input type="submit" id="faqbutton" name="submitsmall" value="Contact zelon88"></input></p>
</form>
</div>
</body>
</html>