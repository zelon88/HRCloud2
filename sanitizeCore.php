...
if (isset($_POST['Save'])) $saveSettings = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['Save']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to load default (current) settings.
if (isset($_POST['LoadDefaults'])) $loadDefaultSettings = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['LoadDefaults']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / The following code sets variables for generating client-side Apps based on user supplied specs. 
if (isset($_POST['GenerateClient'])) $GenerateClient = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['GenerateClient']), ENT_QUOTES, 'UTF-8');
if (isset($_POST['GenClientOS'])) $GenClientOS = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['GenClientOS']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['GenClientCPU'])) $GenClientCPU = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['GenClientCPU']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['GenClientHomepage'])) $GenClientHomepage = htmlentities(str_replace(str_split('\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['GenClientHomepage']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['DataCompression'])) $DataCompression = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['DataCompression']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['DataCompressionMethod'])) $DataCompressionMethod = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['DataCompressionMethod']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWDataCompression'])) $DataCompressionMethod = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWDataCompression']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to clear the HRCloud2 cache files. Accepts a value of '1' or 'true'.
if (isset($_POST['ClearCachePOST'])) $ClearCachePOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['ClearCachePOST']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['ClearUserCache'])) $ClearCachePOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['ClearUserCache']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['ClearCache'])) $ClearCachePOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['ClearCache']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['ClearFavorites'])) $ClearFavoritesPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['ClearFavorites']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to specify new permission settings.
if (isset($_POST['NEWApacheUser'])) $NEWApacheUser = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWApacheUser']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWApacheGroup'])) $NEWApacheGroup = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWApacheGroup']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWCLPerms'])) $NEWCLPerms = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWCLPerms']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWILPerms'])) $NEWILPerms = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWILPerms']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to specify a specific file or directory within a users Cloud to scan for viruses with ClamAV.
if (isset($_POST['NEWVirusScan'])) $NEWVirusScan = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWVirusScan']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['userscanfilename'])) $userscanfilename = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['userscanfilename']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['scanSelected'])) $scanSelected = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['scanSelected']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['HighPerformanceAV'])) $HighPerformanceAV = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['HighPerformanceAV']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWHighPerformanceAV'])) $NEWHighPerformanceAV = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<\''), '', $_POST['NEWHighPerformanceAV']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWThoroughAV'])) $NEWThoroughAV = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<\''), '', $_POST['NEWThoroughAV']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWPersistentAV'])) $NEWPersistentAV = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<\''), '', $_POST['NEWPersistentAV']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWEnableTermsOfServiceURL'])) $NEWTOSEnableURL = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWEnableTermsOfServiceURL']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to sanitize new settings inputs.
if (isset($_POST['NEWColorScheme'])) $NEWColorScheme = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWColorScheme']), ENT_QUOTES, 'UTF-8');
if (isset($_POST['NEWShowHRAI'])) $NEWShowHRAI = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWShowHRAI']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWHRAIAudio'])) $NEWHRAIAudio = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWHRAIAudio']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWShowTips'])) $NEWShowTips = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWShowTips']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWTimezone'])) $NEWTimezone = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWTimezone']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWNickname'])) $NEWNickname = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWNickname']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWFont'])) $NEWFont = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWFont']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWEnablePrivacyPolicyURL'])) $NEWPPEnableURL = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWEnablePrivacyPolicyURL']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWEnableTermsOfServiceURL'])) $NEWTOSEnableURL = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['NEWEnableTermsOfServiceURL']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWPrivacyPolicyURL'])) $NEWPrivacyPolicyURL = htmlentities(str_replace(str_split('|\\~#[](){};$!#^>*<"\'"\''), '', $_POST['NEWPrivacyPolicyURL']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['NEWTermsOfServiceURL'])) $NEWTermsOfServiceURL = htmlentities(str_replace(str_split('|\\~#[](){};$!#^>*<"\''), '', $_POST['NEWTermsOfServiceURL']), ENT_QUOTES, 'UTF-8'); 
...
if (isset($_POST['AutoUpdate'])) $AutoUpdatePOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['AutoUpdate']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['AutoDownload'])) $AutoDownloadPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['AutoDownload']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['AutoInstall'])) $AutoInstallPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['AutoInstall']), ENT_QUOTES, 'UTF-8'); 

// / Can be used to clean up the HRC2 temp directories and perform compatibility adjustments after a manual update.
  // / ONLY ADMINISTRATORS CAN DOWNLOAD HRC2 UPDATES !!!
if (isset($_POST['AutoClean'])) $AutoCleanPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['AutoClean']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to automatically check for and repair compatibility bugs and known issues.
  // / Accepts a value of '1' or 'true'.
if (isset($_POST['CheckCompatibility'])) $CheckCompatPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['CheckCompatibility']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['CheckCompat'])) $CheckCompatPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['CheckCompat']), ENT_QUOTES, 'UTF-8'); 
if (isset($_POST['CheckPermissions'])) $CheckPermsPOST = htmlentities(str_replace(str_split('|\\~#[](){};:$!#^&%@>*<"\''), '', $_POST['CheckPermissions']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['dirToMake'])) $MAKEUserDir = htmlentities(str_replace(str_split('|\\.~#[](){};:$!#^&%@>*<"\''), '', $_POST['dirToMake']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST["dearchiveButton"])) $_POST['dearchiveButton'] = htmlentities(str_replace(str_split('|~#[](){};:$!#^&%@>*<"\''), '', $_POST['dearchiveButton']), ENT_QUOTES, 'UTF-8'); 
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['convertSelected'])) {
  ...
  if (isset($_POST['bitrate'])) $_POST['bitrate'] = htmlentities(str_replace(str_split('|~#[](){};:$!#^&%@>*<"\''), '', $_POST['bitrate']), ENT_QUOTES, 'UTF-8'); }
// / -----------------------------------------------------------------------------------
...
if (isset($_POST['favoriteConfirm'])) $_POST['favoriteConfirm'] = str_replace(str_split('|~#[](){};:$!#^&%@>*<\''), '', $_POST['favoriteConfirm']); 
// / -----------------------------------------------------------------------------------

// / -----------------------------------------------------------------------------------
// / Can be used to remove selected files from a users favorite files.
if (isset($_POST['favoriteDelete'])) $_POST['favoriteDelete'] = str_replace(str_split('|~#[](){};:$!#^&%@>*<\''), '', $_POST['favoriteDelete']); 
// / -----------------------------------------------------------------------------------
